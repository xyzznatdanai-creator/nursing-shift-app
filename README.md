# Nursing Shift — Phase 1 + V1.1 + V1.2 + V1.3 (Authentication + Shift + Personal Planning + Smart Schedule)
...
เวลาว่างอัตโนมัติ, และ **V1.3 "Smart Schedule"** เพิ่มชั้นการวิเคราะห์ตาราง
...
**ยังไม่ทำ (ตาม Scope ของ V1.3):** AI, Machine Learning, AI Recommendation,
Push Notification, Reminder, ระบบแลกเวร, แชร์ตาราง, Chat, Social Features,
...
supabase/
  schema.sql                    → SQL สร้างตาราง + Row Level Security (Phase 1 + V1.1 + V1.2 —
                                   V1.3 ไม่มีการเปลี่ยนแปลง Schema)
```
